...
<html lang="vi">
    ...
    <body style="background-color: #B3AFAF">
        ...
        <div class="container pt-2 pb-2 color-main2" style="background-color: #FFAF4D">
            ...
            <p><center>
                <img src="http://my.teamobi.com/images/new.gif"> FORUMDPV.COM <img src="http://my.teamobi.com/images/new.gif">
            </center></p>
        <div class="row mb-2">
            <div class="col">
            ...
            <c:if test="${totalPage == 2}">
                <div class="col text-right">
                    <c:if test="${page == 1}">
                        ...
                        <a href="topic?id=${getposts.getId()}&&page=${page+1}" class="btn btn-sm" style="background-color: white; color: #561D00">${page+1}</a>
                        <a href="topic?id=${getposts.getId()}&&page=${page+1}" class="btn btn-sm" style="background-color: white; color: #561D00">></a>
                    </c:if>
            ...
            <c:if test="${totalPage > 2}">
                <div class="col text-right">
                    <c:if test="${page == 1}">
                        <a class="btn btn-sm" style="background-color: #561D00; color: white">1</a>
                        <a href="topic?id=${getposts.getId()}&&page=${page+1}" class="btn btn-sm" style="background-color: white; color: #561D00">${page+1}</a>
                        <a href="topic?id=${getposts.getId()}&&page=${page+2}" class="btn btn-sm" style="background-color: white; color: #561D00">${page+2}</a>
                        <a href="topic?id=${getposts.getId()}&&page=${page+1}" class="btn btn-sm" style="background-color: white; color: #561D00">></a>
                    </c:if>
